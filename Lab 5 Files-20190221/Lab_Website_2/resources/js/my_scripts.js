...
function loadStatsPage()
{
	...
	var home_cell_value;
	var away_cell_value;
	var stat_table=document.getElementById("stats_table");
	var wins=0;
	var losses=0;
	for(row_counter = 2; row_counter < stat_table.rows.length; row_counter++)
	{
		home_cell_value=stat_table.rows[row_counter].cells[2].innerHTML;
		away_cell_value=stat_table.rows[row_counter].cells[3].innerHTML;
		if(home_cell_value>away_cell_value)
		{
			stat_table.rows[row_counter].cells[4].innerHTML='Buffs';
			wins++;
		}
		else{
			stat_table.rows[row_counter].cells[4].innerHTML=stat_table.rows[row_counter].cells[1].innerHTML
			losses++;
		}
	}
...
function loadPlayersPage()
	{
        ...
        myInnerHtml += "<a class='player_selector' href='#' style='color:black; text-decoration:none' onclick='switchPlayers("+x+")'>" +players[x].name+ "</a>"+ "<br>";
      
 	
     
		}
		mydropdown.innerHTML = myInnerHtml;
